...
| dcc-gen-0 (LKE)  | 139.162.152.128 | 6863 | `139.162.152.128:6863` | Newark:6868 + gen-1 + val-0 |
| dcc-gen-1 (LKE)  | 139.162.152.128 | 6864 | `139.162.152.128:6864` | Newark:6868 + gen-0 + val-0 |
| dcc-val-0 (LKE)  | 139.162.152.128 | 6865 | `139.162.152.128:6865` | Newark:6868 + gen-0 + gen-1 |
...
2. **Firewall egress.** Newark's Cloud Firewall `outbound_policy = DROP` must allow
   ...
   from Newark: `python3 -c "import socket;socket.create_connection(('139.162.152.128',6863),5)"`
...
3. **Frankfurt inbound.** LKE Cloud Firewall (`linode_firewall.lke_nodes`) must allow
   inbound 6863-6865. Test from anywhere: `nc -zv 139.162.152.128 6863` → succeed.
